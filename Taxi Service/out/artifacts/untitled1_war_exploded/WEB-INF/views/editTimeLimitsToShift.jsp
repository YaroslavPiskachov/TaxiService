...
<script src="<c:url value="/resources/js/Shift_validator.js"/>" type="text/javascript"></script>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <form:form name="shiftTimeForm" id="tab" modelAttribute="Shift" method="POST" action="/editDriverToShift"  onsubmit="return validate_form ( );">
                        <div class="tab-pane active in" id="home">

                            <div class="form-group">
                                <label> Время начала смены</label>
                                <input name="timeIn" value="${Shift.timeIn}"  path="timeIn" type="datatime" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label> Время окончания смены</label>
                                <input name="timeOut" value="${Shift.timeOut}" path="timeOut" type="text" value="" class="form-control">
                                <input name="idShift" value="${Shift.idShift}" path="timeOut" type="hidden" value="" class="form-control">
                            </div>
                        </div>

                        <div class="btn-toolbar list-toolbar">
                            <button class="btn btn-primary" type="submit" > Выбрать свободного водителя</button>
                        </div>
                    </form:form>
                </div>
            </div>
