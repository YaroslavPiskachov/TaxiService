        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <form:form name="driverForm" id="tab" modelAttribute="Driver" method="POST" action="/addDriver"  onsubmit="return validate_form ( );">
                    <div class="tab-pane active in" id="home">

                            <div class="form-group">
                                <label>Фамилия имя отчество</label>
                                <input name="fullName"  path="fullName" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Номер телефона</label>
                                <input name="mobNumber"  path="mobNumber"   type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Опыт вождения</label>
                                <input name="expiriance"  path="expiriance" type="text" value="" class="form-control">
                            </div>
                    </div>
