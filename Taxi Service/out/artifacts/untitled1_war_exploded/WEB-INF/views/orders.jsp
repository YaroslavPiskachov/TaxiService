...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <form action="/order">
                <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Добавить заказ</button>
            </form>
        ...
        <table class="table">
            <thead>
            <tr>
                <th> Адресс начальной точки маршрута</th>
                <th> Адресс конечной точки маршрута</th>
                <th> Цена</th>
                <th> Проеханная дистанция (км)</th>
                <th> Дата и время поступления заказа</th>
            ...
            <c:forEach items="${Booking}" var="booking">
                <tr>
                    <td>${booking.addressDeparture}</td>
                    <td>${booking.addressArrive}</td>
                    <td>${booking.price}</td>
                    <td>${booking.distance}</td>
                    <td>${booking.time}</td>
                    <td>${booking.countPassangers}</td>
                    <td>${booking.shiftsEntity.driverEntity.fullName}</td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
