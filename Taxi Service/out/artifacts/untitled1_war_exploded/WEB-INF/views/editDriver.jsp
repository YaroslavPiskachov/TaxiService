...
<script src="<c:url value="/resources/js/Driver_validator.js"/>" type="text/javascript"></script>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <form:form name="driverForm" id="tab" modelAttribute="Driver" method="POST" action="/updateDriver" onsubmit="return validate_form ( );">
                        <div class="tab-pane active in" id="home">
                            <div class="form-group">
                                <label>Фамилия имя отчество</label>
                                <input name="fullName" value="${Driver.fullName}"  path="fullName" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Номер телефона</label>
                                <input name="mobNumber"  value="${Driver.mobNumber}" path="mobNumber"   type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Опыт вождения</label>
                                <input name="expiriance" value="${Driver.expiriance}" path="expiriance" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>#</label>
                                <input name="idWorker" value="${Driver.idWorker}" path="expiriance" type="text" value="" class="form-control" readonly>
                            </div>
                        </div>
