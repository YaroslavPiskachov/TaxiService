    ...
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <form action="/dispatcher">
                <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Добавить диспетчера</button>
            </form>
        ...
        <table class="table">
            ...
            <tbody>
            <c:forEach items="${Dispatchers}" var="dispatchers">
                <tr>
                    <td>${dispatchers.personalCode}</td>
                    <td>${dispatchers.fullName}</td>
                    <td>${dispatchers.age}</td>
                    <td>
                        <a href="/editDispatcher?Dispatcher=${dispatchers.personalCode}"><i class="fa fa-pencil"></i></a>
                        <a href="/deleteDispatcher?Dispatcher=${dispatchers.personalCode}" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
