...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <h3> Список машин которые свободны с ${ShiftTimeIn} до ${ShiftTimeOut}</h3>
            <h2><a href="/updateShift?Driver=${Driver}&ShiftId=${ShiftId}&ShiftTimeIn=${ShiftTimeIn}&ShiftTimeOut=${ShiftTimeOut}&Car=${Car}">${keepCar}</a> </h2>
        ...
        <table class="table">
            ...
            <c:forEach items="${Cars}" var="car">
                <tr>
                    <td><a href="/updateShift?Driver=${Driver}&ShiftId=${ShiftId}&ShiftTimeIn=${ShiftTimeIn}&ShiftTimeOut=${ShiftTimeOut}&Car=${car.id_car}">${car.model}</a></td>
                    <td>${car.year}</td>
                </tr>
            </c:forEach>
            </tbody>
