        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <form:form name="carForm" id="tab" modelAttribute="Car" method="POST" action="/addCar"  onsubmit="return validate_form ( );">
                        <div class="tab-pane active in" id="home">

                            <div class="form-group">
                                <label>Номер авто</label>
                                <input name="numberOfCar"  path="numberOfCar" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Модель и марка авто</label>
                                <input name="model"  path="model"   type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Год выпуска</label>
                                <input name="year"  path="year" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Расход(л./100км)</label>
                                <input name="gasolineRate"  path="gasolineRate" type="text" value="" class="form-control">
                            </div>
                        </div>
