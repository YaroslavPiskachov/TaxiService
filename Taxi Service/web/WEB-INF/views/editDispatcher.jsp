...
<script src="<c:url value="/resources/js/Dispatcher_validator.js"/>" type="text/javascript"></script>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <form:form name="dispatcherForm" id="tab" modelAttribute="${Dispatcher}" method="POST" action="/updateDispatcher" onsubmit="return validate_form ( );">
                        <div class="tab-pane active in" id="home">
                            <div class="form-group">
                                <label>Фамилия имя отчество</label>
                                <input name="fullName" value="${Dispatcher.fullName}"  path="fullName" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label> Возраст</label>
                                <input name="age"  value="${Dispatcher.age}" path="age"   type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label> Личный код</label>
                                <input name="personalCode" value="${Dispatcher.personalCode}" path="personalCode" type="text" value="" class="form-control" readonly>
                            </div>
                        </div>
