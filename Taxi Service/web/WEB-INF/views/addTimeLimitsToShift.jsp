        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <form:form name="shiftTimeForm" id="tab" modelAttribute="Shift" method="POST" action="/addDriverToShift"  onsubmit="return validate_form ( );">
                        <div class="tab-pane active in" id="home">

                            <div class="form-group">
                                <label> Время начала смены</label>
                                <input name="timeIn" value="${Shift.timeIn}"  path="timeIn" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
