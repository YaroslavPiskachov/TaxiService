...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <form action="/car">
                <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Добавить машину</button>
            </form>
        ...
        <table class="table">
            ...
            <c:forEach items="${Cars}" var="car">
                <tr>
                    <td>${car.numberOfCar}</td>
                    <td>${car.model}</td>
                    <td>${car.year}</td>
                    <td>${car.gasolineRate}</td>
                    <td>
                        <a href="/editCar?Car=${car.id_car}"><i class="fa fa-pencil"></i></a>
                        <a href="/deleteCar?Car=${car.id_car}" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
