...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <form action="/shift">
                <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Добавить смену</button>
            </form>
        ...
        <table class="table">
            ...
            <c:forEach items="${Shifts}" var="shifts">
                <tr>
                    <td>${shifts.timeIn}</td>
                    <td>${shifts.timeOut}</td>
                    <td>${shifts.driverEntity.fullName}</td>
                    <td>${shifts.carEntity.model} ${shifts.carEntity.year}</td>
                    <td>
                        <a href="/editShift?Shift=${shifts.idShift}"><i class="fa fa-pencil"></i></a>
                        <a href="/deleteShift?Shift=${shifts.idShift}" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
