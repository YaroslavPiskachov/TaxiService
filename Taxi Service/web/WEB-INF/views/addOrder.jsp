...
<script src="<c:url value="/resources/js/Order_validator.js"/>" type="text/javascript"></script>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <form:form name="orderForm" id="tab" modelAttribute="Booking" method="POST" action="/addDriverToOrder"  onsubmit="return validate_form ( );">
                        <div class="tab-pane active in" id="home">

                            <div class="form-group">
                                <label>Адресс начальной точки маршрута</label>
                                <input name="addressDeparture"  path="addressDeparture" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Адресс конечной точки маршрута</label>
                                <input name="addressArrive"  path="addressArrive" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Проеханная дистанция(км)</label>
                                <input name="distance"  path="distance" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Количество пассажиров</label>
                                <input name="countPassangers"  path="countPassangers" type="text" value="" class="form-control">
                            </div>
