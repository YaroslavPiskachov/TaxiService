...
<script src="<c:url value="/resources/js/Car_validator.js"/>" type="text/javascript"></script>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <form:form name="carForm" id="tab" modelAttribute="Car" method="POST" action="/updateCar"  onsubmit="return validate_form ( );">
                        <div class="tab-pane active in" id="home">

                            <div class="form-group">
                                <label>Номер авто</label>
                                <input name="numberOfCar" value="${Car.numberOfCar}"  path="numberOfCar" type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Модель и марка авто</label>
                                <input name="model"  path="model" value="${Car.model}"   type="text" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Год выпуска</label>
                                <input name="year"  path="year" value="${Car.year}" type="text"  class="form-control">
                                <input name="id_car" value="${Car.id_car}" type="hidden"  class="form-control" >
                            </div>
                            <div class="form-group">
                                <label>Расход(л./100км)</label>
                                <input name="gasolineRate" value="${Car.gasolineRate}"  path="gasolineRate" type="text" value="" class="form-control">
                            </div>
                        </div>

                        <div class="btn-toolbar list-toolbar">
                            <button class="btn btn-primary" type="submit" ><i class="fa fa-save"></i> Изменить</button>
                        </div>
                    </form:form>
                </div>
            </div>
