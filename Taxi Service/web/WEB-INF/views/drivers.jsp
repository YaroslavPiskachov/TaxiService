...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <form action="/driver">
            <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Добавить водителя</button>
            </form>
        ...
        <table class="table">
            ...
            <tr>
                <td>${drivers.idWorker}</td>
                <td>${drivers.fullName}</td>
                <td>${drivers.expiriance}</td>
                <td>${drivers.mobNumber}</td>
                <td>
                    <a href="/editDriver?Driver=${drivers.idWorker}"><i class="fa fa-pencil"></i></a>
                    <a href="/deleteDriver?Driver=${drivers.idWorker}" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                </td>
            </tr>
            </c:forEach>
            </tbody>
