...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <h3> Список водителей которые могут принять смену с ${Shift.timeIn} до ${Shift.timeOut}</h3>
        ...
        <table class="table">
            ...
            <c:forEach items="${Drivers}" var="drivers">
                <tr>
                    <td><a href="/addCarToShift?Driver=${drivers.idWorker}&ShiftTimeIn=${Shift.timeIn}&ShiftTimeOut=${Shift.timeOut}">${drivers.fullName}</a></td>
