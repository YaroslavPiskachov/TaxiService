...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <h3> Список машин которые свободны с ${Shift.timeIn} до ${Shift.timeOut}</h3>
            <h2><a href="/editCarToShift?Driver=${Shift.driverEntity.idWorker}&ShiftId=${Shift.idShift}&ShiftTimeIn=${Shift.timeIn}&ShiftTimeOut=${Shift.timeOut}">${keepDriver}</a> </h2>
        ...
        <table class="table">
            ...
            <c:forEach items="${Drivers}" var="drivers">
                <tr>
                    <td><a href="/editCarToShift?Driver=${drivers.idWorker}&ShiftId=${Shift.idShift}&ShiftTimeIn=${Shift.timeIn}&ShiftTimeOut=${Shift.timeOut}">${drivers.fullName}</a></td>
                    <td>${drivers.expiriance}</td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
